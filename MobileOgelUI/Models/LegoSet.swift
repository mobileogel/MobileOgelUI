...
struct LegoSetMockData {
    ...
    static let allSampleData: [LegoSet] = [LegoSet(setId: 1, setName: "Apple", pieceCount: 8, setUrl: "https://drive.google.com/file/d/1sjQtH2KMxZfr3F6KUIVQ6aPAZbQ4UeeW/view?usp=sharing"), LegoSet(setId: 2, setName: "House", pieceCount:13, piecesMissing: [LegoPiece(imageName: "X1-Y2-Z2_Transparent", pieceName: "1x2 Brick", quantity: 2, officialColour: .transClear), LegoPiece(imageName: "X2-Y2-Z2-FILLET_Lavender", pieceName: "2x2 Fillet Brick", quantity: 2, officialColour: .lavender)], setUrl: "https://drive.google.com/file/d/1CNiT5Ucsq-kgkMVC5ukQZpGyMBiKbpih/view?usp=sharing")]
