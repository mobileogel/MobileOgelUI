...
class LegoSetDBManager{
    ...
    func findPerfectMatches(allSets: [[String:Any]], myPieces: [LegoPiece]) -> [LegoSet] {
    ...
    func findFuzzyMatches(allSets: [[String:Any]], myPieces: [LegoPiece]) -> [LegoSet] {
